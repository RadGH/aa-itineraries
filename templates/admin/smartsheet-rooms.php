...
$base_url = admin_url('admin.php?page=ah-smartsheet-rooms');

// Visiting this URL loads data from smartsheet
$sync_url = add_query_arg(array('ah_sync_rooms' => 1), $base_url);

// Get the last sync time
$sync_date = get_option( 'ah_rooms_last_sync', false );

// Get sheet settings
$sheet_id = AH_Smartsheet_Sync_Rooms()->get_sheet_id();
$column_ids = AH_Smartsheet_Sync_Rooms()->get_column_ids();
$sheet_url = AH_Smartsheet_Sync_Rooms()->get_smartsheet_permalink();
$columns = AH_Smartsheet_Sync_Rooms()->columns;

// Get rooms from a prior Smartsheet sync
$room_list = AH_Smartsheet_Sync_Rooms()->get_stored_room_list();
?>

<div class="wrap">
	
	<h1>Smartsheet - Sync Rooms</h1>
				...
				<div id="postbox-container-1" class="ah-postbox-sidebar postbox-container">
					...
					<div class="ah-postbox-sticky">
						...
						<div class="postbox">
							...
							<div class="inside">
								<p>Updates the room list with current information from the rooms master spreadsheet.</p>
